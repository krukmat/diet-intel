...
Se revisaron los archivos `agnostic-ai-pipeline/AGENTS.md` y `agnostic-ai-pipeline/CLAUDE.md` para identificar políticas reutilizables que aplican en este repositorio. Estas son las pautas que hemos adoptado y documentado aquí:
...
## Instrucciones reutilizadas de CLAUDE.md
