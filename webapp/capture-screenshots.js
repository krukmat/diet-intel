                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="flex justify-center">
                        <div class="relative w-64 h-64 flex items-center justify-center">
                            <div class="w-48 h-48 rounded-full" style="background: conic-gradient(#3b82f6 0deg 108deg, #ef4444 108deg 252deg, #22c55e 252deg 360deg);"></div>
                            <div class="absolute inset-0 flex items-center justify-center">
                                <div class="w-24 h-24 bg-white rounded-full flex items-center justify-center">
                                    <span class="text-lg font-bold text-gray-900">Macros</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <div class="w-16 h-16 relative">
                            ...
                            <div class="absolute inset-0 w-16 h-16 rounded-full border-4 border-blue-500" style="clip-path: polygon(50% 0%, 100% 0%, 95% 50%, 50% 50%);"></div>
                            <div class="absolute inset-0 flex items-center justify-center">
                                <span class="text-xs font-medium text-gray-600">95%</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow meal-card" style="border-left-color: #10b981;">
                <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <div class="w-16 h-16 relative">
                            <div class="w-16 h-16 rounded-full border-4 border-gray-200"></div>
                            <div class="absolute inset-0 w-16 h-16 rounded-full border-4 border-green-500" style="clip-path: polygon(50% 0%, 100% 0%, 97% 50%, 50% 50%);"></div>
                            <div class="absolute inset-0 flex items-center justify-center">
                                <span class="text-xs font-medium text-gray-600">97%</span>
                            </div>
                        </div>
                    </div>
                </div>
