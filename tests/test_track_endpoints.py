...
class TestTrackMealEndpoint:
    ...
    @patch('app.services.cache.cache_service.set')
    @patch.object(track_router_module.tracking_service, 'get_meal_by_id')
    @patch.object(track_router_module.tracking_service, 'create_meal')
...
class TestTrackWeightEndpoint:
    ...
    @patch('app.services.cache.cache_service.set')
    @patch.object(track_router_module.tracking_service, 'get_weight_entry_by_id')
    @patch.object(track_router_module.tracking_service, 'create_weight_entry')
...
class TestWeightHistoryEndpoint:
    ...
    @patch.object(track_router_module.tracking_service, 'get_user_weight_history')
...
class TestPhotoLogsEndpoint:
    ...
    @patch.object(track_router_module.tracking_service, 'get_user_weight_history')
    @patch.object(track_router_module.tracking_service, 'get_user_meals')
